...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.save_for_backward(colors_precomp, means3D, beta, a, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer)
    ...
    def backward(ctx, grad_out_color, grad_radii, grad_depth):
        ...
        colors_precomp, means3D, beta, a, scales, rotations, cov3Ds_precomp, radii, sh, geomBuffer, binningBuffer, imgBuffer = ctx.saved_tensors
        ...
        if raster_settings.debug:
            cpu_args = cpu_deep_copy_tuple(args) # Copy them before they can be corrupted
            try:
                grad_means2D, grad_colors_precomp, grad_opacities, grad_beta, grad_a, grad_means3D, grad_cov3Ds_precomp, grad_sh, grad_scales, grad_rotations = _C.rasterize_gaussians_backward(*args)
            except Exception as ex:
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, beta, a, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None):
